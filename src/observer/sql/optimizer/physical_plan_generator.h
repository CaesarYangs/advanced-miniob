...
private:
  ...
  RC create_plan(UpdateLogicalOperator &update, std::unique_ptr<PhysicalOperator> &oper);
  ...
  RC create_plan(AnalyzeLogicalOperator &logical_oper, std::unique_ptr<PhysicalOperator> &oper);
};
